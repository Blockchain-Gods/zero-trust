        ...
        <div className="relative z-10 p-6">
          ...
          <div className="max-w-400 mx-auto mb-6">
            <div className="relative">
              ...
              <div className="relative bg-[#1a2332]/90 backdrop-blur-sm border-2 border-[#00e5ff]/60 p-4 clip-corners">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-4">
                    <div className="flex items-center gap-2 bg-[#fbbf24]/20 border border-[#fbbf24]/60 px-4 py-2 clip-corners">
          ...
          <div className="max-w-400 mx-auto grid grid-cols-12 gap-6">
            ...
            <div className="col-span-6 space-y-4">
              ...
              <div className="text-[10px] text-[#94a3b8] bg-[#1a2332]/50 p-3 rounded border border-[#64748b]/30">
                ...
                timeline. Each ability creates a timed event. Events loop based
                on your bot type (Worm = 60s, Standard = 90s, Logic Bomb = no
                loop).
              </div>
            </div>
                    ...
                    state.timeline
                      ...
                      .map((event) => (
                        ...
                        >
                          ...
                          <span className="text-[#fbbf24]">{event.cost}🪙</span>
                        </div>
                      ))
                  )}
                </div>
          ...
          <div className="max-w-400 mx-auto mt-6">
            <div className="bg-[#1a2332]/90 backdrop-blur-sm border-2 border-[#00e5ff]/60 p-4 clip-corners">
...
function ConfigPanel({
  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-[#1a2332]/90 backdrop-blur-sm border-2 border-[#00e5ff]/60 p-3 clip-corners">
