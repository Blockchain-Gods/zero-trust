...
export type BotType =
  | { tag: "Malware"; values: void }
  | { tag: "Trojan"; values: void }
  | { tag: "Ransomware"; values: void }
  | { tag: "Worm"; values: void }
  | { tag: "Rootkit"; values: void }
  | { tag: "Spyware"; values: void }
  | { tag: "Botnet"; values: void }
  | { tag: "LogicBomb"; values: void };

export type SystemTargetId =
  | { tag: "Compute"; values: void }
  | { tag: "Storage"; values: void }
  | { tag: "Network"; values: void }
  | { tag: "Auth"; values: void }
  | { tag: "Analytics"; values: void }
  | { tag: "Communication"; values: void }
  | { tag: "Transaction"; values: void }
  | { tag: "Api"; values: void }
  | { tag: "Endpoint"; values: void }
  | { tag: "Cdn"; values: void }
  | { tag: "Iot"; values: void };

export type ResourceAttackType =
  | { tag: "Cpu"; values: void }
  | { tag: "Memory"; values: void }
  | { tag: "Bandwidth"; values: void }
  | { tag: "Disk"; values: void }
  | { tag: "None"; values: void };

export type VictoryCondition =
  | { tag: "TimeSurvival"; values: void }
  | { tag: "SystemDestruction"; values: void }
  | { tag: "DataExfiltration"; values: void };

export type SpecialAbility =
  | { tag: "Stealth"; values: void }
  | { tag: "Mutation"; values: void }
  | { tag: "Replication"; values: void }
  | { tag: "Encryption"; values: void }
  | { tag: "Persistence"; values: void };

export type SpawnPattern =
  | { tag: "Steady"; values: void }
  | { tag: "Burst"; values: void }
  | { tag: "Crescendo"; values: void };

export type SkillDiversity =
  | { tag: "Low"; values: void }
  | { tag: "Medium"; values: void }
  | { tag: "High"; values: void };
...
export type DataKey =
  ...
  | { tag: "BotConfig"; values: readonly [u32] }
  | { tag: "BotMetadata"; values: readonly [u32] };
...
export interface Client {
   ...
   */
  deploy_bot: (
    { owner, bot_config }: { owner: string; bot_config: BotConfig },
  ...
  get_bot_config: (
    ...
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<BotConfig>>;
  ...
  get_bot_metadata: (
    { token_id }: { token_id: u32 },
    options?: MethodOptions,
  ) => Promise<AssembledTransaction<BotMetadata>>;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "",
